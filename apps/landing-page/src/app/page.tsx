...
export default function Home() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-surface text-ink">
      <a
        href="#main-content"
        className="fixed left-4 top-4 z-50 -translate-y-24 rounded-xl bg-white px-4 py-3 text-sm font-bold text-brand transition-transform focus:translate-y-0 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 motion-reduce:transition-none"
      >
        Skip to content
      </a>
      ...
      <header className="relative z-10 bg-brand">
        <div className="mx-auto flex h-20 w-full max-w-7xl items-center justify-between gap-2 px-5 sm:h-24 sm:px-10 lg:px-16">
          <a
            href="#top"
            className="flex h-14 shrink-0 items-center rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-brand"
            aria-label="SkateU home"
          >
            <Image
              src={IMAGES.brandLockup}
              alt=""
              className="h-12 w-[260px] object-contain object-left"
              priority
            />
          </a>
        </div>
