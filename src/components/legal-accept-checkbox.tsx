  ...
  return (
    <View>
      ...
      <FeedbackPressable
        ...
        accessibilityLabel="Agree to SkateU Terms, Community Guidelines, Privacy Policy, and confirm you are at least 13"
      >
        <View
        ...
        <Text className="ml-3 min-w-0 flex-1 font-outfit-medium text-base leading-6 text-ink">
          I agree and confirm I am at least 13 years old.
        </Text>
      </FeedbackPressable>
    </View>
  );
