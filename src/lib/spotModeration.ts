...
Reject as IRRELEVANT only when the image and text together provide no plausible spot or session context, such as pure random letters or characters, obvious spam, meme-only or nonsensical text, or a clearly unrelated image paired with no meaningful context. Imperfect but meaningful words are enough; do not confuse misspellings or unusual skate slang with gibberish. When uncertain between a genuine-looking spot claim and irrelevance, approve. Only the APPROPRIATENESS and privacy rules override this leniency.
